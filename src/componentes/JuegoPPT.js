...
if(x===1){
  setImgRingComputadoraInicio(
    imagenPapelComputadora()    
  )
 
}
else if(x===2){
  setImgRingComputadoraInicio(
    imagenPiedraComputadora()
  )

}else if(x===3){
  setImgRingComputadoraInicio(
    imagenTijeraComputadora()
  ) 
}
...
/>
  ...
  setMensajes(
    <p className='tipoTexto'>Personaje 1 Activado</p>
  )
  ...
  setMensajes(
    <p className='tipoTexto'>Personajes 1 y 2 Activados</p>
  )
  ...
  setMensajes(
    <p className='tipoTexto'>Personajes 1,2 y 3 Activados</p>
  )
  ...
  setMensajes(
    <p className='tipoTexto'>Personajes 1,2,3 y 4 Activados</p>
)
...
<div>
  <p id='textoIndisponibilidadPPT' >No es posible Mostrar el proyecto por que el dispostivo no cumple con el tamaño apropiado</p>
</div>
...
<div id='contenedorPrincipalJuegoPPT' >  
     ...
     <div>
       ...
       <h1 className='titulo' >JUEGO PIEDRA PAPEL Y TIJERA</h1>
     </div>
     ...
     <div id='contenedorJuego'>
          ...
          <section id="sec3">
             <p className='vistaPuntaje' >Puntos Jugador</p>              
          ...
          <section id="sec4">
{
 ...
 <div>
    <button id="botonLimpiarActivo"   onClick={() => limpiar()} >Limpiar</button>
     <button id="botonJugar" className='botonJugar' >Jugar</button>
  ...
  (
  <div>
    <button id="botonLimpiar" className='botonLimpiar' >Limpiar</button>
    <button id="botonJugarActivo"   onClick={() => jugar()} >Jugar</button>
          ...
          <section id="sec5">
           <div className='posicionImgenRing'>
               {imgComputadora}
           </div>
          </section>
                    ...
                    <div>
                      {
                        ...
                        (
                          <div>
                   <button   className='botonControlJugador' onClick={() => papel()}>
                 <img  id="opPapel"
                      className='imagen3  configurarImgControlJugador'
                      src={opcionJ1}
                      alt="opcionJ1.png"
                 /></button>         
                  <button   className='botonControlJugador' onClick={() => piedra()}>
                  <img  id="opPiedra"  
                      className='imagen3 configurarImgControlJugador'
                      src={opcionJ3}
                       alt="opcionJ3.png"
                  /></button>  
                    <button id="opTijera"   className='botonControlJugador' onClick={() => tijera()}>
                    <img 
                      className='imagen3 configurarImgControlJugador'
                      src={opcionJ2}
                      alt="opcionJ3.png"
      ...
      <div id='contenedorMensajes'>
                            ...
                            <div>
                              ...
                              {
                                x === 1 && y === 1 ? (<h3 className='tipoTexto'>Empate de  Papel</h3>): 
                                x === 1 && y === 2 ? (<h3 className='tipoTexto'>Gana Computadora</h3>): 
                                x === 1 && y === 3 ? (<h3 className='tipoTexto'>Gana Jugador</h3>): 
                                x === 2 && y === 1 ? (<h3 className='tipoTexto'>Gana Jugador</h3>): 
                                x === 2 && y === 2 ? (<h3 className='tipoTexto'>Empate de Piedra</h3>): 
                                x === 2 && y === 3 ? (<h3 className='tipoTexto'>Gana Computadora</h3>):
                                x === 3 && y === 1 ? (<h3 className='tipoTexto'>Gana Computadora</h3>): 
                                x === 3 && y === 2 ? (<h3 className='tipoTexto'>Gana Jugador</h3>): 
                                x === 3 && y === 3 ? (<h3 className='tipoTexto'>Empate de Tijeras</h3>):
                                ("")

                              }
                            </div>

                              <div className='coloresMensaje'>
                              {mensajes}   
                              </div>
                      </div>
      </section>
