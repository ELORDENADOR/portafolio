...
const respuestaPreguntaFinal4 = (x) =>{
  ...
  return (
<ContenedorCuesoDeIdiomas>

<div>
  <p id='textoIndisponibilidadCursoDeIdiomas' >No es posible Mostrar el proyecto por que el dispostivo no cumple con el tamaño apropiado</p>
</div>
       ...
       <div>     
           {
               /////////////////////////////    NIVEL 0 //////////////////////////
                   ...
                   (                                  
                       <div id='contenedorNivel0'>
                           ...
                           <div id='seccionTextoNivel0'>
                               <p>
                               Bienvenido al Curso de ingles mas utilizado y apetecido en el mundo,
                               Mi nombre es Chemo, soy un Robot Instructor y te guiare durante este curso. 
                               nosotros brindamos una estructura unica y funcional, 
                               en la cual te permitira adquirir un nivel de Ingles Nativo 
                               sin importar tu lengua Materna, pero antes de empezar si te preguntas por que tengo 
                               dientes si soy un Robot no te preocupes, es para que te fijes en 
                               eso y no los errores
                               que mi creador no a corregido. ahora si , empecemos.
                               para avanzar y retroceder en el curso solo dale click en los 
                               botones que se encuentran abajo a la izquierda. 
                               </p>
                           </div>
                   ...
                   <div id='contenedorNivel'>
                           ...
                           <div id='seccionTextoNivel'>
                               <p>
                                   Ahora podemos iniciar, Porfavor dale click en las imagenes de los animales 
                                   que se encuentran abajo.esto nos servira para entrar en contexto con las lecciones.
                                   cuando termines de escuchar todas, sigue adelante en el curso.
                               </p>
                           </div>
                        ...
                        <div id='ContenedorLeccionesNivel'>
                               <button className='confDivBotonesImagenesNivel'  onClick={()=> sonidoGato("Cat")} >
                                   Gato<br></br>
                                   <img className='confBotonesImagenesNivel' src={gato}></img>
                               </button>
                               <button className='confDivBotonesImagenesNivel' onClick={()=> sonidoPerro("Dog")} >
                                   Perro<br></br>
                                   <img className='confBotonesImagenesNivel' src={perro}></img>
                               </button>
                               <button className='confDivBotonesImagenesNivel'  onClick={()=> sonidoVaca("Cow")}>
                                   Vaca<br></br>
                                   <img className='confBotonesImagenesNivel' src={vaca}></img>
                               </button>
                               <button className='confDivBotonesImagenesNivel' onClick={()=> sonidoGallo("Rooster")}>
                                   Gallo<br></br>
                                   <img className='confBotonesImagenesNivel' src={gallo}></img>
                               </button>               
                       </div>
                   ...
                   (
                       ...
                       <div id='seccionTextoNivel'>
                           <p>
                             Muy bien, ahora que ya tenemos idea de lo que estamos 
                             trabajando, iniciaremos con la correcta pronunciacion 
                             de los nombres de los animales anteriores en ingles.
                             da click en cada uno de ellos y cuando termines de escuchar todos, sigue adelante en el curso.
                           </p>
                       </div>
                    ...
                    <div id='ContenedorLeccionesNivel'>
                           <button className='confDivBotonesImagenesNivel'  onClick={()=> sonidoCat("Cat")} >
                               Cat<br></br>
                               <img className='confBotonesImagenesNivel' src={gato}></img>
                           </button>
                           <button className='confDivBotonesImagenesNivel' onClick={()=> sonidoDog("Dog")} >
                               Dog<br></br>
                               <img className='confBotonesImagenesNivel' src={perro}></img>
                           </button>
                           <button className='confDivBotonesImagenesNivel'  onClick={()=> sonidoCow("Cow")}>
                               Cow<br></br>
                               <img className='confBotonesImagenesNivel' src={vaca}></img>
                           </button>
                           <button className='confDivBotonesImagenesNivel' onClick={()=> sonidoRooster("Rooster")}>
                               Rooster<br></br>
                               <img className='confBotonesImagenesNivel' src={gallo}></img>
                           </button>               
                   </div>
                   ...
                   (                        
                       ...
                       <div id='seccionTextoNivel'>
                           <p>
                            ...
                            deberas escrivir el nombre correcto del animal y dar click en la imagen correspondiente, si es correcto
                            aparecera el nombre del animal junto con un OK, esto te indicara 
                            que esta bien escrita. cuando termines de escribir todas, sigue adelante en el curso.
                           </p>
                       </div>
               ...
               <div id='ContenedorLeccionesNivel'>                          
                       ...
                       <form  onSubmit={nombreGato}>               
                               ...
                               /><br></br>
                               <button id='botonQuienEsElAnimal' onClick={() => ComparacionGato()}>                        
                       ...
                       <form  onSubmit={nombrePerro}>               
                               ...
                               /><br></br>
                               <button id='botonQuienEsElAnimal' onClick={() => ComparacionPerro()}>                        
                      ...
                      <form  onSubmit={nombreVaca}>               
                               ...
                               /><br></br>
                               <button id='botonQuienEsElAnimal' onClick={() => ComparacionVaca()}>                        
                       ...
                       <form  onSubmit={nombreGallo}>               
                               ...
                               /><br></br>
                               <button id='botonQuienEsElAnimal' onClick={() => ComparacionGallo()}>                        
...

                           {
                               estadoGallo === true ?
                                   ...
                                   <div id='contenedorRespuestaQueAnimalEs'>
                                      <p id='isRooster' >
                                         {
                                           nombreRooster === "Rooster" ?("Rooster OK") : ("Rooster Fake")
                                           }
                                      </p>
                                   </div>                                             
                                   )               
                   ...
                   (     
                       ...
                       <div id='seccionTextoNivel'>
                           <p>
                               Muy bien, ahora presiona el sonido secreto y ubica la imagen que 
                               le corresponde.si es correcto automaticamente de dira ok, 
                               cuando termines la actividad, sigue adelante en el curso.
                           </p>
                       </div>
                    ...
                    <div id='ContenedorLeccionesNivel'>
                           <button className='confDivBotonesImagenesNivel' onClick={()=> escuchaPerro(2)} >
                               Dog<br></br>
                               <img className='confBotonesImagenesNivel' src={perro}></img>
                           </button>

                           <button className='confDivBotonesImagenesNivel'  onClick={()=> escuchaGato(1)} >
                               Cat<br></br>
                               <img className='confBotonesImagenesNivel' src={gato}></img>
                           </button>
                           <button className='confDivBotonesImagenesNivel' onClick={()=> escuchaGallo(4)}>
                               Rooter<br></br>
                               <img className='confBotonesImagenesNivel' src={gallo}></img>
                           </button> 
                           <button className='confDivBotonesImagenesNivel'  onClick={()=> escuchaVaca(3)}>
                               Cow<br></br>
                               <img className='confBotonesImagenesNivel' src={vaca}></img>
                           </button>
                       ...
                       <div id='seccionRespuesta'>
                               {
                                   ...
                                   :
                                   (
                                       <button className='confAnimalScreto' onClick={() =>animalSecreto(1)}>?</button>
                                   )
                               }

                               {
                                   ...
                                   :
                                   (
                                       <button className='confAnimalScreto' onClick={() =>animalSecreto(2)}>?</button>
                                   )
                               }
                               {
                                   correctoCow ? 
                                   ...
                                   :
                                   (
                                       <button className='confAnimalScreto' onClick={() =>animalSecreto(3)}>?</button>
                                   )
                               }
                               {
                                   correctoRooster ? 
                                   ...
                                   :
                                   (
                                       <button className='confAnimalScreto' onClick={() =>animalSecreto(4)}>?</button>
                                   )
                               }                            
                      </div>                            
               </div>  
                   ...
                   (     
                       <div id='contenedorExamen'>
                           ...
                           <div id='seccionTextoExamen'>
                               <p>
                             Finalmente hagamos la ultima leccion, en esta veremos todo lo aprendido:
                             seran cuatro preguntas las cuales estan desarrolladas de la siguiente manera:

                             En la primera frase deberas escribir el nombre del animal que corresponda segun el texto. 
                             luego daras ok si crees que es el nombre es correcto.

                             En la segunda Frase deberas seleccionar el animal que coresponda segun el texto.
                             En la tercera frase deberas escuchar los dos audios que se encuentran en incognita 
                             y  seleccionar el que  corresponda segun el texto.

                             En la cuarta frase deberas seleccionar el nombre del animal segun el texto.

                             Cada vez que tengas la respuesta correcta te regalaremos una estrella como premio.
                               </p>
                           </div>
                           ...
                           <div id='ContenedorLeccionesExamen'>                         
                               ...
                               the <input    
                                   ...
                                   />
                                   <button id='botonRespuesta1'>                     
                                       ok                       
                                  </button>
                                  

                                     woke up the family at four in the morning.


                                     That's why the mother went to get the milk from the.


                                      <button id='botonQuienEsElAnimal' onClick={() => respuestaPreguntaFinal2(1)}>                        
                                      <img className='confImgQueAnimalEs' src={gallo}></img>
                                      </button> 
                                      <button id='botonQuienEsElAnimal' onClick={() => respuestaPreguntaFinal2(2)}>                        
                                      <img className='confImgQueAnimalEs' src={vaca}></img>
                                      </button>

                                      <br></br><br></br>
                                      early.
                                      at that moment the boy hears the 
                                      <button className='confAnimalScreto' onClick={() =>respuestaPreguntaFinal3(3)}>?</button>
                                      <button className='confAnimalScreto' onClick={() =>respuestaPreguntaFinal3(2)}>?</button>
                                     
                                      <br></br><br></br>barking because the 
                                      <button className='confBotonPregunta4' onClick={() =>respuestaPreguntaFinal4(1)}>Dog</button>
                                      <button className='confBotonPregunta4' onClick={() =>respuestaPreguntaFinal4(2)}>Cat</button>                                                                           
                           ...
                           <div>
                           {
                               pregunta1Correcta ? 
                               (
                               <FontAwesomeIcon  className='confPuntoCorrecto' icon={faStar} /> 
                               )
                               :
                               (
                                 <p></p>
               ...
               (
                   ...
                   <div id='seccionTextoFinal'>
                       <p>
                       Bueno eso es todo, espero que te hayas divertido con este increible curso.
                       Ya de seguro lograstes alcanzar un nivel nativo del idioma Ingles, asi que comparte este curso 
                       con tus amigos y familiares para que tambien aprendan.
                       </p>
                   </div>

                   {/* <div id='ContenedorLeccionesFinal'>                         
                   ...
                   {/* <div id='seccionApoyoFinal'>
                       
                   </div> */}
                   

                   {/* <div id='seccionRespuestaFinal'>
...
const  ContenedorCuesoDeIdiomas = styled.nav`
...
// #seccionLeccionExamen{
// 	background-color: orange;
//     grid-area: seccionLeccionExamen;
...
// #ContenedorLeccionesFinal{
//     background-color: red;
//     grid-area: ContenedorLeccionesFinal;
//     text-align: center;
// }
...
// #seccionApoyoFinal{
// 	background-color: orange;
//     grid-area: seccionApoyoFinal;
// }

// #seccionRespuestaFinal{
// 	background-color: green;
//     grid-area: seccionRespuestaFinal;
//     display: flex;
//     justify-content: center;
//     flex-wrap: wrap; 
// }
