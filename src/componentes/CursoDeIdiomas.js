...
export const CursoDeIdiomas = () => {
  ...
  return (
    <ContenedorCuesoDeIdiomas>
      <div>
        <p id="textoIndisponibilidadCursoDeIdiomas">
                ...
                <div id="contenedorNivel">
                  ...
                  <div id="seccionTextoNivel">
                    <p>
                      ...
                      trabajando, iniciaremos con la correcta pronunciacion de
                      los nombres de los animales anteriores en ingles. da click
                      en cada uno de ellos y cuando termines de escuchar todos,
              ...
              nivel === 5 ? (
                <div id="contenedorExamen">
                  ...
                  <div id="seccionTextoExamen">
                    <p>
                      Finalmente hagamos la ultima leccion, en esta veremos todo
                      lo aprendido: seran cuatro preguntas las cuales estan
                      desarrolladas de la siguiente manera: En la primera frase
                      deberas escribir el nombre del animal que corresponda
                      segun el texto. luego daras ok si crees que es el nombre
                      es correcto. En la segunda Frase deberas seleccionar el
                      animal que coresponda segun el texto. En la tercera frase
                      deberas escuchar los dos audios que se encuentran en
                      incognita y seleccionar el que corresponda segun el texto.
                      En la cuarta frase deberas seleccionar el nombre del
                      animal segun el texto. Cada vez que tengas la respuesta
                      correcta te regalaremos una estrella como premio.
                    </p>
                  </div>
